...
export function IrelandPage() {
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent('Hello! I am interested in studying in Ireland. Please guide me.');
    window.open(`https://wa.me/917299005577?text=${message}`, '_blank');
  };

  const handleFormSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent('Ireland Study Abroad Enquiry');
  ...
  const whyIrelandPoints = [
    {
      icon: Award,
      title: 'World-Class Education',
      desc: 'Home to globally ranked universities and cutting-edge research',
      color: 'from-[#1E40AF] to-[#3B82F6]'
    },
    {
      icon: Globe,
      title: 'EU Gateway',
      desc: 'Study in Ireland, access to entire European Union',
      color: 'from-[#10B981] to-[#059669]'
    },
    {
      icon: Briefcase,
      title: 'Tech Hub of Europe',
      desc: 'Home to Google, Facebook, Apple, Microsoft, and more',
      color: 'from-[#F59E0B] to-[#D97706]'
    },
    {
      icon: DollarSign,
      title: 'Post-Study Work Visa',
      desc: '2-year stay-back visa for graduates',
      color: 'from-[#8B5CF6] to-[#7C3AED]'
    },
    {
      icon: Users,
      title: 'Friendly & Welcoming',
      desc: 'English-speaking country with warm Irish hospitality',
      color: 'from-[#EC4899] to-[#DB2777]'
    },
    {
      icon: Shield,
      title: 'Safe Environment',
      desc: 'Peaceful, secure country with low crime rates',
  ...
  const popularCourses = [
    {
      ...
      icon: Code,
      color: 'from-[#1E40AF] to-[#3B82F6]',
      searchUrl: 'https://www.google.com/search?q=Computer+Science+IT+courses+in+Ireland'
    },
    {
      name: 'Business & Management',
      icon: Briefcase,
      color: 'from-[#10B981] to-[#059669]',
      searchUrl: 'https://www.google.com/search?q=Business+MBA+courses+in+Ireland'
    },
    {
      name: 'Data Science & Analytics',
      icon: Laptop,
      color: 'from-[#F59E0B] to-[#D97706]',
      searchUrl: 'https://www.google.com/search?q=Data+Science+courses+in+Ireland'
    },
    {
      name: 'Pharmaceutical Sciences',
      icon: Beaker,
      color: 'from-[#EC4899] to-[#DB2777]',
      searchUrl: 'https://www.google.com/search?q=Pharmaceutical+Sciences+courses+in+Ireland'
    },
    {
      name: 'Engineering',
      icon: Award,
      color: 'from-[#8B5CF6] to-[#7C3AED]',
      searchUrl: 'https://www.google.com/search?q=Engineering+courses+in+Ireland'
    },
    {
      name: 'Health Sciences',
      icon: Activity,
      color: 'from-[#06B6D4] to-[#0891B2]',
      searchUrl: 'https://www.google.com/search?q=Health+Sciences+courses+in+Ireland'
    },
    {
      name: 'Finance & Accounting',
      icon: DollarSign,
      color: 'from-[#F97316] to-[#EA580C]',
      searchUrl: 'https://www.google.com/search?q=Finance+Accounting+courses+in+Ireland'
    }
  ];
  ...
  const universities = [
    ...
    },
    {
      ...
      programs: ['Business', 'Engineering', 'Sciences', 'Health'],
    ...
    },
    {
      ...
      rank: 'QS #289',
      location: 'Galway',
      tuition: '€14,000 - €22,000',
      programs: ['IT', 'Medicine', 'Business', 'Engineering'],
    ...
    },
    {
      ...
      rank: 'QS #292',
      location: 'Cork',
      tuition: '€14,500 - €21,000',
      programs: ['Pharmacy', 'Food Science', 'Business', 'IT'],
    ...
    },
    {
      ...
      rank: 'Ireland\'s Largest',
      location: 'Dublin',
      tuition: '€12,000 - €18,000',
      programs: ['Technology', 'Business', 'Arts', 'Sciences'],
    ...
    },
    {
      ...
      location: 'Maynooth',
      tuition: '€13,000 - €19,500',
      programs: ['Sciences', 'Business', 'Arts', 'Social Sciences'],
    ...
    },
    {
      ...
      location: 'Limerick',
      tuition: '€13,500 - €20,000',
      programs: ['Engineering', 'Business', 'IT', 'Health Sciences'],
  ...
  const intakes = [
    {
      ...
      applicationPeriod: 'January - May',
      startDate: 'September',
      advantages: ['Maximum course availability', 'Best for undergraduate programs', 'Scholarship opportunities'],
      color: 'from-[#1E40AF] to-[#3B82F6]'
    },
    {
      name: 'January Intake',
      season: '❄️ Spring Semester',
      popular: 'Secondary Intake',
      applicationPeriod: 'August - November',
      startDate: 'January',
      advantages: ['Postgraduate programs', 'Less competition', 'Quick admission'],
      color: 'from-[#10B981] to-[#059669]'
    }
  ];
  ...
  const visaProcess = [
    {
      ...
      description: 'Receive acceptance letter from Irish university',
      items: ['Letter of acceptance', 'Proof of fee payment', 'Course confirmation']
    },
    {
      step: '2',
      title: 'Prepare Documents',
      description: 'Gather all required documents',
      items: ['Valid passport', 'Academic transcripts', 'Proof of funds (€10,000/year)', 'English proficiency', 'Medical insurance']
    },
    {
      step: '3',
      title: 'Apply for Visa',
      description: 'Submit application online',
      items: ['Complete application form', 'Upload documents', 'Pay visa fee (€300)', 'Schedule appointment']
    },
    {
      step: '4',
      title: 'Visa Processing',
      description: 'Wait for decision (8-12 weeks)',
      items: ['Track application online', 'Attend interview if required', 'Provide additional docs if needed']
    },
    {
      step: '5',
      title: 'Travel to Ireland',
      description: 'Receive visa and prepare for departure',
      items: ['Register with immigration within 90 days', 'Get Irish Residence Permit (IRP)', 'Start your studies']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F0F4FF] to-white">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div ref={servicesRef} className="relative">
                ...
                >
                  <div className="p-2">
                    <button
                      onClick={() => scrollToSection('why-ireland')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-md px-5 py-3 rounded-full border border-[#E5E9F2] mb-6 shadow-sm hover:shadow-lg hover:scale-105 transition-all duration-300">
                <img
                  ...
                  alt="Official Flag of Ireland"
                  className="w-8 h-6 object-cover rounded shadow-sm"
                />
                <span className="text-[#2b2d72] text-[14px] font-bold">Europe's Tech Hub</span>
              </div>
              ...
              <p className="text-[#475569] text-base sm:text-lg md:text-xl leading-relaxed mb-8">
                Gateway to Europe with world-class education, global tech giants, and 2-year post-study work visa. Ireland welcomes <span className="font-bold text-[#2b2d72]">35,000+</span> international students every year.
              </p>

              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white/60 backdrop-blur-md rounded-xl p-4 border border-[#E5E9F2]">
                  <div className="text-2xl sm:text-[28px] font-bold text-[#2b2d72]">9</div>
                ...
                <div className="bg-white/60 backdrop-blur-md rounded-xl p-4 border border-[#E5E9F2]">
                  ...
                  <div className="text-gray-600 text-[13px]">Stay-Back</div>
                </div>
                <div className="bg-white/60 backdrop-blur-md rounded-xl p-4 border border-[#E5E9F2]">
                  <div className="text-2xl sm:text-[28px] font-bold text-[#2b2d72]">EU</div>
                  <div className="text-gray-600 text-[13px]">Access</div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1549918864-48ac978761a4?w=800&h=600&fit=crop"
                  alt="Dublin City Ireland"
      ...
      <section id="why-ireland" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-base sm:text-lg max-w-3xl mx-auto">
              Ireland offers exceptional opportunities for international students
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyIrelandPoints.map((point, index) => {
      ...
      <section id="visa-process" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-base sm:text-lg">
              Step-by-step guide to getting your Ireland student visa
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#1E40AF] to-[#3B82F6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/90 text-[20px] mb-10">
            Get free expert guidance for studying in Ireland from our experienced counsellors
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Get in touch with our expert counselors for personalized guidance on studying in Ireland.
              </p>
